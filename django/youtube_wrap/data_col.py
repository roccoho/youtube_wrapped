...
WATCH_HIST_CSV = './youtube_wrap/uploads/watch_hist.csv'
VIDEO_RESPONSE_JSON = './youtube_wrap/uploads/video_response.json'
CHANNEL_RESPONSE_JSON = './youtube_wrap/uploads/channel_response.json'
VIDEO_INFO_CSV = './youtube_wrap/uploads/video_info.csv'
CHANNEL_INFO_CSV = './youtube_wrap/uploads/channel_info.csv'
YEAR = 2021
